...
public class Bow : Weapon {
	...
	*/
	...
	{
		if(_entity.combatState == CombatState.Aiming) _entity._anim.SetBool("Blocking", true);
		base.Update();
	}
	...
	IEnumerator Aim()
	{
		...
		while(!_entity._stamina.Ready) yield return null;
	...
	void FireArrow(float progress)
	{
		...
		_entity._stamina.Drain(regularAttackStaminaDrain);
	}
