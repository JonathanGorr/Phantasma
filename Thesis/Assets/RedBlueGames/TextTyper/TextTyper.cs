namespace RedBlueGames.Tools.TextTyper
{
    ...
    public class TextTyper : MonoBehaviour
    {
		...
		[SerializeField]
        [Tooltip("Event that's called when the text has finished printing.")]
        private UnityEvent lineBegan = new UnityEvent();
		...
		/// <summary>
        /// Gets the LineBegan callback event.
        /// </summary>
        /// <value>The print completed callback event.</value>
        public UnityEvent LineBegan
        {
            get
            {
        ...
        public void TypeText(ConversationEntry text, float printDelay = -1)
        {
            this.defaultPrintDelay = printDelay > 0 ? printDelay : PrintDelaySetting;
            this.printingText = text.ConversationText;
            ...
            this.typeTextCoroutine = this.StartCoroutine(this.TypeTextCharByChar(text.ConversationText));
        }
        ...
        {
            if (this.LineBegan != null)
            {
                this.LineBegan.Invoke();
            }
        }
